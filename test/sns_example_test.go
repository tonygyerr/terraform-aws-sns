...
func TestTerraformLambdaExample(t *testing.T) {
	...
	assert.Contains(t, planOut, "module.users_encrypted.aws_sns_topic.this[0] will be created")
	assert.Contains(t, planOut, "module.users_unencrypted.aws_sns_topic.this[0] will be created")
